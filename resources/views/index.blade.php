...
@section('content')
    <form id="metrics-form">
        <div class="container mb-3">
            <div class="container-inputs mb-3">
                <label class="form-label" for="url">{{ __('metrics.url') }}</label>
                ...
                <div class="form-group">
                    <label class="form-label" for="strategy">{{ __('metrics.strategy') }}</label>
                    <div class="form-check form-check-inline">
            ...
            <div class="mb-3">
                <button type="button" class="btn btn-primary" id="submit-btn">{{__('metrics.getMetrics')}}</button>
            </div>
        </div>
    </form>
    <form id="metrics-results-form" class="d-none">
        ...
        <div class="form-group mb-3 text-center">
            <button type="button" class="btn btn-success" id="save-metrics-btn">{{__('metrics.saveMetric')}}</button>
        </div>
    </form>
@endsection